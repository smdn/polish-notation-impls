...
## 制限事項
デモサーバーの実行には、バージョン8.0以上の[.NET SDK](https://docs.microsoft.com/ja-jp/dotnet/core/sdk)、および[HttpListener](https://docs.microsoft.com/ja-jp/dotnet/api/system.net.httplistener)を使用できるプラットフォームが必要です。
